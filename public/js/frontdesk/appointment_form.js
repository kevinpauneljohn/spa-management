        ...
        content +='<div class="form-group">';
            content +='<div class="row">';
                content +='<div class="col-md-12">';
                    ...
                    content +='<input type="text" class="form-control filterClientAppointment clientFilterAppointent'+id+'" id="'+id+'" autoComplete="none">';
        ...
        content +='<div class="form-group hidden clientServiceApp clientService_appointment'+id+'">';
            content +='<div class="row defaultOptionalService">';
                content +='<div class="col-md-6">';
                    ...
                    content +='<input '+disabled+' class="form-control start_time_appointment" type="datetime-local" name="start_time_appointment'+id+'" id="start_time_appointment'+id+'">';
                content +='</div>';
            content +='</div>';
            content +='<div class="row hidden requiredService requiredService'+id+'">';
                ...
                content +='<div class="col-md-4">';
                    ...
                    content += '<input '+disabled+' data-id="'+id+'" type="datetime-local" name="start_time_appointment_walkin'+id+'" id="start_time_appointment_walkin'+id+'" class="form-control start_time_appointment_walkin">';
