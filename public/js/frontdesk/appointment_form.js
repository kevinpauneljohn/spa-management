        ...
        content +='<div class="form-group hidden clientServiceApp clientService_appointment'+id+'">';
            content +='<div class="row defaultOptionalService">';
                content +='<div class="col-md-6">';
                    ...
                    content +='<select data-select="new" data-id="'+id+'" name="service_name_appointment'+id+'" id="service_name_appointment'+id+'" class="form-control select-services-appointment" style="width:100%;"></select>';
                    ...
                    content +='<input type="hidden" name="appointment_plus_time_price_optional'+id+'" id="appointment_plus_time_price_optional'+id+'" class="form-control">';
                content +='</div>';
                content +='<div class="col-md-6">';
