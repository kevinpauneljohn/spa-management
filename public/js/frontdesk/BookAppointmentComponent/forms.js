    ...
    var content = '<div class="tab-pane '+active+' appointmentContent tabAppointmentContent'+id+'" id="appointment'+id+'">';
        ...
        content +='<div class="form-group hidden clientServiceApp clientService_appointment'+id+'">';
            ...
            content +='</div>';
                ...
                content +='<div class="col-md-4 PreparationTimeDiv walkInStartTimeDiv">';
                    content +='<label for="start_time_appointment_walkin'+id+'">Preparation Time</label>&nbsp;<i class="fas fa-question-circle text-primary" data-toggle="tooltip" data-placement="top" title="By choosing preparation time, it will automatically set the start time."></i>';
                    ...
                    content += '<input '+disabled+' data-id="'+id+'" type="datetime-local" name="start_time_appointment_walkin'+id+'" id="start_time_appointment_walkin'+id+'" class="form-control start_time_appointment_walkin hidden" min="">';
                ...
                content +='</div>';
                content +='<div class="col-md-4 hidden ServiceAppointmentDiv walkInHiddenDiv'+id+'">';
                    ...
                    content +='<input type="hidden" name="appointment_service_multiple'+id+'" id="appointment_service_multiple'+id+'" class="form-control">';
                content +='</div>';
                content +='<div class="col-md-4 hidden PlusTimeAppointmentDiv walkInHiddenDiv'+id+'">';
                ...
                content +='</div>';
            content +='</div><br />';
            content +='<div class="row hidden requiredTherapist requiredTherapist'+id+' walkInHiddenDiv'+id+'">';
                content +='<div class="col-md-4 AppointmentRoomDiv appointment_room_div'+id+'">';
                ...
                content +='</div>';
                content +='<div class="col-md-4 AppointmentMasseurDiv1 appointment_masseur1_div'+id+' hidden">';
                ...
                content +='</div>';
                content +='<div class="col-md-4 AppointmentMasseurDiv2 appointment_masseur2_div'+id+' hidden">';
