...
@section('content')
    <div class="row">
        <div class="col-sm-6">
            <h3 class="text-info">Spa Management</h3>
        </div>
        <div class="col-sm-6">
        ...
        <div class="col-md-3">
            <div class="card card-info card-outline">
                <div class="card-body box-profile">
                    ...
                    <h3 class="profile-username text-center">{{ucwords(strtolower($owners['firstname']))}} {{ucwords(strtolower($owners['lastname']))}}</h3>
                    ...
                    <div class="tab-content">
                        <div class="active tab-pane" id="data">
                            <div class="row">
                                <div class="col-md-12">
                                    @can('add spa')
                                        <button type="button" class="btn bg-gradient-orange btn-sm float-right text-white" id="addNewSpa">Add Spa</button>
                                    @endcan
                                </div>
                            </div><br />
                            <div class="row">
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer justify-content-between">
                            ...
                            <input type="button" class="btn bg-gradient-info add-spa-btn" value="Save">
                        </div>
                    </div>
                </div>
            </form>
