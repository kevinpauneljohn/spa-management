...
//        ]);
        ...
        Permission::create(['name' => 'view attendance'])->syncRoles(['owner','HR Manager']);
        Permission::create(['name' => 'add attendance'])->syncRoles(['owner','HR Manager']);
        Permission::create(['name' => 'edit attendance'])->syncRoles(['owner','HR Manager']);
        Permission::create(['name' => 'delete attendance'])->syncRoles(['owner','HR Manager']);
    }
}
